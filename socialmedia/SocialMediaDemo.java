...
public class SocialMediaDemo implements Runnable {
    ...
    private void analyzeYouTubeVideos() {
        ...
        VideoAdapter adapter1 = new VideoAdapter(new YouTubeVideo("MormonMessages", "Bullying",
                "President Uchtdorf counsels us to stop bullying."));
        VideoAdapter adapter2 = new VideoAdapter(new YouTubeVideo("MormonMessages", "Patterns of Light",
                "Elder Bednar teaches about the Light of Christ."));
        VideoAdapter adapter3 = new VideoAdapter(new YouTubeVideo("Randy Pausch", "The Last Lecture",
                "Achieving your childhood dreams."));
        
        List<SocialMediaEntry> entries = new ArrayList<>();
        
        // YouTubeVideo does not implement the correct interface to allow this!
        entries.add(adapter1);
        entries.add(adapter2);
        entries.add(adapter3);
